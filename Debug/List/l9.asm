...
; 0000 0031 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(255)
	OUT  0x11,R30
...
; 0000 0040 // Clock value: 15,625 kHz
; 0000 0041 // Mode: Ph. correct PWM top=0x00FF
; 0000 0042 // OC1A output: Disconnected
; 0000 0043 // OC1B output: Non-Inverted PWM
; 0000 0044 // Noise Canceler: Off
; 0000 0045 // Input Capture on Falling Edge
; 0000 0046 // Timer Period: 32,64 ms
; 0000 0047 // Output Pulse(s):
; 0000 0048 // OC1B Period: 32,64 ms Width: 0 us
...
; 0000 004D TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (1<<WGM10);
	LDI  R30,LOW(33)
	OUT  0x2F,R30
; 0000 004E TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (1<<CS12) | (0<<CS11) | (0<<CS10);
	LDI  R30,LOW(4)
	OUT  0x2E,R30
...
; 0000 0079 // ADC Clock frequency: 31,250 kHz
; 0000 007A // ADC Voltage Reference: AVCC pin
; 0000 007B // ADC High Speed Mode: Off
...
; 0000 007F ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(96)
	OUT  0x7,R30
; 0000 0080 ADCSRA=(1<<ADEN) | (0<<ADSC) | (1<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(167)
	OUT  0x6,R30
; 0000 0081 SFIOR=(1<<ADHSM) | (0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(16)
	OUT  0x30,R30
; 0000 0082 
